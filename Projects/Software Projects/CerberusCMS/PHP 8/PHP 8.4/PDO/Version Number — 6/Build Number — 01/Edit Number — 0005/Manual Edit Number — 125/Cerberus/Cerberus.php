...
// [ C ] $_KERNEL_DATABASE_SERVER_CONNECT_MySQL_STANDARD 				= mysql_connect($_ACCESS_DATABASE_SERVER_HOSTNAME, $_ACCESS_DATABASE_SERVER_USERNAME, $_ACCESS_DATABASE_SERVER_PASSWORD, $_ACCESS_DATABASE_SERVER_HOSTNAME_PORT);
// [ C ] $_KERNEL_DATABASE_SERVER_DATABASE_NAME_SELECT_MySQL_STANDARD 			= mysql_select_db($_ACCESS_DATABASE_SERVER_DATABASE_NAME);
...
// [ C ] $_KERNEL_DATABASE_SERVER_CONNECT_MySQL_IMPROVED 				= new mysqli($_ACCESS_DATABASE_SERVER_HOSTNAME, $_ACCESS_DATABASE_SERVER_USERNAME, $_ACCESS_DATABASE_SERVER_PASSWORD, $_ACCESS_DATABASE_SERVER_DATABASE_NAME);
// [ C ] $_KERNEL_DATABASE_SERVER_DATABASE_NAME_SELECT_MySQL_IMPROVED 			= $_KERNEL_DATABASE_SERVER_CONNECT_MySQL_IMPROVED->select_db($_ACCESS_DATABASE_SERVER_DATABASE_NAME);

/*
 ============================================================================================================
 + Database Management System Server :: System Connection :: Variables :: P.H.P. Data Objects :: Standard
 ============================================================================================================
*/

$_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION				= new PDO("mysql:host=$_ACCESS_DATABASE_SERVER_HOSTNAME;dbname=$_ACCESS_DATABASE_SERVER_DATABASE_NAME", $_ACCESS_DATABASE_SERVER_USERNAME, $_ACCESS_DATABASE_SERVER_PASSWORD);
$_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
...
if ($_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION) {
...
// [ C ] if ($_KERNEL_DATABASE_SERVER_DATABASE_NAME_SELECT_MySQL_IMPROVED) {
...
// [ C ] mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);
...
$_DB_Query_Kernel_Select_System_Settings_Kernel_Installation				= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_kernel WHERE id='1'");
$_DB_Query_Kernel_Select_System_Settings_Kernel_Installation_Fetch_Array		= $_DB_Query_Kernel_Select_System_Settings_Kernel_Installation->fetch();
...
$_DB_Query_Kernel_Select_System_Settings_Kernel_Current					= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_kernel WHERE id='2'");
$_DB_Query_Kernel_Select_System_Settings_Kernel_Current_Fetch_Array			= $_DB_Query_Kernel_Select_System_Settings_Kernel_Current->fetch();
...
$_DB_Query_Kernel_Select_System_Settings						= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_settings WHERE id='1'");
$_DB_Query_Kernel_Select_System_Settings_Fetch_Array					= $_DB_Query_Kernel_Select_System_Settings->fetch();
...
$_DB_Query_Kernel_Select_Member_Credentials 						= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME'");
$_DB_Query_Kernel_Select_Member_Credentials_Fetch_Array 				= $_DB_Query_Kernel_Select_Member_Credentials->fetch();
...
$_DB_Query_Kernel_Security_Update_Member_Account_Force_Logout			= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_security_setting_flag_force_logout='0' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME'");
...
$_DB_Query_Kernel_Security_Check_Cookie_Member_UserName_AND_Password 					= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME' AND member_password='$_GLOBAL_COOKIE_MEMBER_PASSWORD'");
$_DB_Query_Kernel_Security_Check_Cookie_Member_UserName_AND_Password_Number_Of_Rows			= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT COUNT(*) FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME' AND member_password='$_GLOBAL_COOKIE_MEMBER_PASSWORD'")->fetchColumn();
...
$_DB_Query_Kernel_Security_Check_Cookie_Member_UserName_AND_Password->closeCursor();
...
$_DB_Query_Kernel_Security_Check_Cookie_Member_Electronic_Mail_Address_Number_Of_Rows			= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT COUNT(*) FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME' AND member_electronic_mail_address='$_GLOBAL_COOKIE_MEMBER_ELECTRONIC_MAIL_ADDRESS'")->fetchColumn();
...
$_DB_Query_Kernel_Security_Check_Cookie_Member_Electronic_Mail_Address->closeCursor();
...
$_DB_Query_Kernel_Networking_Status_Security_Check_Blocked_Networks				= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_networking WHERE blocked_ip_address_string='$_GLOBAL_REMOTE_SERVER_ADDRESS' ORDER BY id ASC");
$_DB_Query_Kernel_Networking_Status_Security_Check_Blocked_Networks_Fetch_Array			= $_DB_Query_Kernel_Networking_Status_Security_Check_Blocked_Networks->fetch();
$_DB_Query_Kernel_Networking_Status_Security_Check_Blocked_Networks_Number_of_Rows		= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT COUNT(*) FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_networking WHERE blocked_ip_address_string='$_GLOBAL_REMOTE_SERVER_ADDRESS' ORDER BY id ASC")->fetchColumn();
...
$_DB_Query_Kernel_Networking_Status_Security_Check_Blocked_Networks->closeCursor();
...
$_DB_Query_Kernel_Update_Member_Rank 							= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_level_rank='$_Kernel_Member_Rank_Level_Update_Digit' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME'");
...
$_DB_Query_Kernel_Update_Member_Rank->closeCursor();
...
$_DB_Query_Kernel_Member_Rank_Select_All_Ranks						= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_ranks ORDER BY id ASC");

while ($_DB_Query_Kernel_Member_Rank_Select_All_Ranks_Fetch_Array = $_DB_Query_Kernel_Member_Rank_Select_All_Ranks->fetch()) {
...
$_DB_Query_Kernel_Member_Rank_Select_All_Ranks->closeCursor();
...
$_DB_Query_Kernel_Login_Set_Member_Status_Account_IP_Address_Last_Authentication_Server_Device	= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_ip_address_last_authentication_server_device='$_GLOBAL_REMOTE_SERVER_ADDRESS' WHERE member_username='$_Kernel_Authenticate_Member_Account_POST_USERNAME_CLEAR'");
$_DB_Query_Kernel_Login_Set_Member_Status_Account_Active										= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_status_account_active='1' WHERE member_username='$_Kernel_Authenticate_Member_Account_POST_USERNAME_CLEAR'");
$_DB_Query_Kernel_Login_Set_Member_Status_Account_Digital_Fingerprints							= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_security_fingerprint_cleartext='$_INTERNAL_SECURITY_GENERATED_MEMBER_FINGERPRINT_AUTHENTICATION_CLEARTEXT',member_security_fingerprint_hashed='$_INTERNAL_SECURITY_GENERATED_MEMBER_FINGERPRINT_AUTHENTICATION_HASHED' WHERE member_username='$_Kernel_Authenticate_Member_Account_POST_USERNAME_CLEAR'");
...
$_DB_Query_Kernel_Login_Set_Member_Status_Account_IP_Address_Last_Authentication_Server_Local->closeCursor();
...
$_DB_Query_Kernel_Login_Set_Member_Status_Account_IP_Address_Last_Authentication_Server_Remote->closeCursor();
...
$_DB_Query_Kernel_Login_Set_Member_Status_Account_IP_Address_Last_Authentication_Server_Device->closeCursor();
...
$DB_Query_Kernel_Member_Account_Update_Attempt_Authentication->closeCursor();
...
$DB_Query_Kernel_Authenticate_Check_Member_Account_Credentials->closeCursor();
...
$DB_Query_Kernel_Authenticate_Check_Member_Account_Credentials_Array->closeCursor();
...
$DB_Query_Kernel_Authenticate_Check_Member_Account_Entry->closeCursor();
...
$_DB_Query_Kernel_Logout_Remove_Member_Account_Authorized_IP_Address				= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_ip_address_authorized='000.000.000.000',member_ip_address_authorized_multifactor='000.000.000.000' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME' AND member_electronic_mail_address='$_GLOBAL_COOKIE_MEMBER_ELECTRONIC_MAIL_ADDRESS'");
$_DB_Query_Kernel_Logout_Remove_Member_Account_Status_Active					= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_status_account_active='0' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME' AND member_electronic_mail_address='$_GLOBAL_COOKIE_MEMBER_ELECTRONIC_MAIL_ADDRESS'");
$_DB_Query_Kernel_Logout_Remove_Member_Account_IP_Authorization_Token				= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_ip_address_authorization_token='0' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME' AND member_electronic_mail_address='$_GLOBAL_COOKIE_MEMBER_ELECTRONIC_MAIL_ADDRESS'");
...
$_DB_Query_Kernel_Logout_Remove_Member_Account_Authorized_IP_Address->closeCursor();
...
$_DB_Query_Kernel_Applications_Panel_Aligned_Left 					= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications_panel_visibility_member WHERE application_panel_alignment='0' AND application_file_status='1' ORDER BY application_panel_row ASC");
...
while ($_DB_Query_Kernel_Applications_Panel_Aligned_Left_Fetch_Array = $_DB_Query_Kernel_Applications_Panel_Aligned_Left->fetch()) {
...
$_DB_Query_Kernel_Applications_Panel_Aligned_Left->closeCursor();
...
$_DB_Query_Kernel_Select_Applications_Services							= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications_administration_root_services ORDER BY id ASC");
...
while ($_DB_Query_Kernel_Select_Applications_Services_Fetch_Array = $_DB_Query_Kernel_Select_Applications_Services->fetch()) {
...
$_DB_Query_Kernel_Select_Applications_Services->closeCursor();
...
$_DB_Query_Kernel_Select_Applications_Root							= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications_administration_root ORDER BY id ASC");
...
while ($_DB_Query_Kernel_Select_Applications_Root_Fetch_Array = $_DB_Query_Kernel_Select_Applications_Root->fetch()) {
...
$_DB_Query_Kernel_Select_Applications_Root->closeCursor();
...
$_DB_Query_Kernel_Select_Applications_Administration 						= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications_administration_visibility_administration ORDER BY id ASC");
...
while ($_DB_Query_Kernel_Select_Applications_Administration_Fetch_Array = $_DB_Query_Kernel_Select_Applications_Administration->fetch()) {
...
$_DB_Query_Kernel_Select_Applications_Administration->closeCursor();
...
$_OPEN_DIRECTORY_APPLICATIONS_MODERATION			= opendir($_FIND_DIRECTORY_APPLICATIONS_MODERATION);
...
closedir($_OPEN_DIRECTORY_APPLICATIONS_MODERATION);
...
$_DB_Query_Kernel_Select_Applications_Member 							= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications_member_visibility_member ORDER BY id ASC");
...
while ($_DB_Query_Kernel_Select_Applications_Member_Fetch_Array	= $_DB_Query_Kernel_Select_Applications_Member->fetch()) {
...
$_DB_Query_Kernel_Select_Custom_Applications 						= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications_custom ORDER BY id ASC");
...
while ($_DB_Query_Kernel_Select_Custom_Applications_Fetch_Array = $_DB_Query_Kernel_Select_Custom_Applications->fetch()) {
...
$_DB_Query_Kernel_Select_Custom_Applications->closeCursor();
...
$_DB_Query_Kernel_Applications_Panel_Aligned_Right 					= $_GLOBAL_DATABASE_MANAGEMENT_SYSTEM_SERVER_DATABASE_CONNECTION->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications_panel_visibility_member WHERE application_panel_alignment='1' AND application_file_status='1' ORDER BY application_panel_row ASC");
...
while ($_DB_Query_Kernel_Applications_Panel_Aligned_Right_Fetch_Array = $_DB_Query_Kernel_Applications_Panel_Aligned_Right->fetch()) {
...
$_DB_Query_Kernel_Applications_Panel_Aligned_Right->closeCursor();
...
$_DB_Query_Kernel_Select_System_Settings->closeCursor();
...
$_DB_Query_Kernel_Select_Member_Credentials->closeCursor();
...
// [ C ] } else {
		...
		// [ C ] echo ("Kernel Message: Error, I Cannot Connect To The Structured Query Language Database Server Name: $_ACCESS_DATABASE_SERVER_DATABASE_NAME. Please Check The Database Server Access Credentials File.");

// [ C ] } // [ + ] IF: Connection To :: Database Server Name :: Variable Has Executed
